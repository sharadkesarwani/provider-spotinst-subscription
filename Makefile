...
PROJECT_NAME ?= provider-spotinst
...
#export TERRAFORM_DOCS_PATH ?= registry.terraform.io/providers/spotinst/spotinst/latest/docs
#export TERRAFORM_DOCS_PATH ?= https://registry.terraform.io/providers/spotinst/spotinst/latest/docs
#export TERRAFORM_DOCS_PATH ?= latest/docs
#export TERRAFORM_DOCS_PATH ?=github.com/spotinst/terraform-provider-spotinst/tree/main/docs/resources
...
xpkg.build.provider-spotinst: do.build.images
